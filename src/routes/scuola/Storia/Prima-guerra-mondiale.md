...
### Russia:
Esce dalla guerra firando il trattato di `Brest-Litovsk`, deve pagare le `indennità di guerra` a Germania e Austria-Ungheria. Perde Estonia, Lituania, Ukraina etc, i giacimenti di carbone e ferro. Il controllo di alcune fabbriche passò alla Germania.
