...
<ul>
	<li>
		<mhi>Inizia nel 1918</mhi> (Prima guerra mondiale), che cambierà la storia, finiscono gli imperi
		e nascono le forme statali
	</li>
	<li>
		<mhi>Finisce nel 1991</mhi> (caduta dell’URSS). Finisce il periodo fascista, le ideologie e il mondo
