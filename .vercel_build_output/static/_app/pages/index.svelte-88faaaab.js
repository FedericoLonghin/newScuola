...
function p(o) {
	...
	return {
		...
		l(o) {
			...
			p = l(s, 'H1', { class: !0 });
			var e = h(p);
			(z = u(e, 'Benvenuto nel nuovino sitino')), e.forEach(c), (g = r(s)), (q = l(s, 'H2', {}));
			var i = h(q);
			(E = u(i, 'Chissà se funziona... bah')), i.forEach(c), (H = r(s)), (b = l(s, 'H2', {}));
			var d = h(b);
			(x = u(
				d,
				'Ah, questo sito è ancora in sviluppo, quindi ci sta che qualcosa faccia schifo/non funzioni...\n\t\t(in realtà è solo una scusa per giudicare le monnezze che non ho voglia di sistemare(in\n\t\trealtà(si, di nuovo) dico che non è che non ho voglia di farlo, ma non me ne accorgo/non so\n\t\tfarlo... umiltà ragazzi... sempre))'
		...
		h() {
			(document.title = 'Home'),
				d(p, 'class', 'svelte-13qm1wo'),
				d(a, 'class', 'content svelte-13qm1wo');
		},
		m(o, s) {
			v(o, n, s),
				v(o, a, s),
