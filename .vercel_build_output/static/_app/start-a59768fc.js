...
function V(t) {
	...
	return (
		a && (e = new a(n(t))),
		{
			...
			m(t, o) {
				e && R(e, t, o), m(t, r, o), (s = !0);
			},
			p(t, s) {
				const i = 4 & s ? L(o, [S(t[2] || {})]) : {};
				if ((521 & s && (i.$$scope = { dirty: s, ctx: t }), a !== (a = t[0][1]))) {
					...
					a
						? ((e = new a(n(t))), b(e.$$.fragment), k(e.$$.fragment, 1), R(e, r.parentNode, r))
						: (e = null);
				} else a && e.$set(i);
			},
			i(t) {
		...
		a && (e = new a(n())),
		{
			...
			p(t, s) {
				...
				if (a !== (a = t[0][2])) {
					...
					a
						? ((e = new a(n())), b(e.$$.fragment), k(e.$$.fragment, 1), R(e, r.parentNode, r))
						: (e = null);
				} else a && e.$set(i);
			},
			i(t) {
...
function z(t) {
	...
	return {
		...
		m(t, a) {
			e && R(e, t, a), m(t, r, a), l && l.m(t, a), m(t, s, a), (o = !0);
		},
		p(t, [o]) {
			const c = 2 & o ? L(a, [S(t[1] || {})]) : {};
...
const J = {},
	...
	H = [
		[/^\/$/, [F[0], F[2]], [F[1]]],
		[/^\/scuola\/Italiano\/?$/, [F[0], F[3]], [F[1]]],
		[/^\/scuola\/Storia\/La-visione-dell-uomo-nel-positivo\/?$/, [F[0], F[4]], [F[1]]],
		[/^\/scuola\/Storia\/Prima-guerra-mondiale\/?$/, [F[0], F[5]], [F[1]]],
		[/^\/scuola\/Storia\/Il-Novecento\/?$/, [F[0], F[6]], [F[1]]],
		[/^\/scuola\/Storia\/?$/, [F[0], F[7]], [F[1]]],
		[/^\/scuola\/?$/, [F[0], F[8]], [F[1]]],
		[/^\/About\/?$/, [F[0], F[9]], [F[1]]],
		[/^\/jason\/?$/]
	],
		...
		(this.renderer = t),
			...
			addEventListener('scroll', () => {
				clearTimeout(s),
					(s = setTimeout(() => {
						const t =
							((s = i({}, history.state || {})), (o = { 'sveltekit:scroll': Z() }), e(s, r(o)));
						var s, o;
		...
		addEventListener('touchstart', o),
			...
			addEventListener('click', (t) => {
				...
				const s = 'object' == typeof r.href && 'SVGAnimatedString' === r.href.constructor.name,
					o = String(s ? r.href.baseVal : r.href);
				if (o === location.href) return void (location.hash || t.preventDefault());
	...
	async goto(t, { noscroll: e = !1, replaceState: r = !1 } = {}, s) {
		...
		return this.enabled && this.owns(o)
			? (history[r ? 'replaceState' : 'pushState']({}, '', t),
			  this._navigate(o, e ? Z() : null, s, o.hash))
	...
	async _navigate(t, e, r, s) {
		...
		if ('/' !== o.path) {
			...
			((t && 'never' === this.trailing_slash) ||
				...
				history.replaceState({}, '', `${o.path}${location.search}`));
		}
		this.renderer.notify({ path: o.path, query: o.query }),
			await this.renderer.update(o, r, !1),
			document.body.focus();
	...
	if (n) {
		const t = JSON.parse(n.textContent),
			...
			r = ((t, e) => {
				...
				if (null != t && s) for (var n of s(t)) e.indexOf(n) < 0 && a.call(t, n) && (r[n] = t[n]);
				return r;
			})(t, ['body']);
...
class ot {
	...
	async start({ status: t, error: e, nodes: r, page: s }) {
		...
		try {
			...
			a = await this._get_navigation_result_from_branch({ page: s, branch: o });
		} catch (u) {
			if (e) throw u;
			(n = 500), (l = u);
		}
		l && (a = await this._load_error({ status: n, error: l, path: s.path, query: s.query })),
			...
			const { started: c } = this,
				u = {
					...
					fetch(t, e) {
						...
						return a.uses.dependencies.push(o), c ? fetch(t, e) : st(t, e);
					}
				};
	...
	async _load({ route: t, path: e, query: r }, s) {
		const o = `${e}?${r}`;
		if (!s && this.cache.has(o)) return this.cache.get(o);
		const [a, n, l, c] = t,
			u = c ? c(a.exec(e)) : {},
			h = this.current.page && {
...
async function at({
	...
	const l = o && new et({ base: t.base, routes: H, trailing_slash: n }),
		c = new ot({ Root: Y, fallback: Q, target: e, session: r, host: s });
	i && (await c.start(i)),
		o && l.init(c),
