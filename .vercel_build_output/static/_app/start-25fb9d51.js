		...
		o && (e = new o(n(t))),
		{
			...
			p(t, s) {
				...
				if ((521 & s && (i.$$scope = { dirty: s, ctx: t }), o !== (o = t[0][1]))) {
					...
					o
						? ((e = new o(n(t))), b(e.$$.fragment), k(e.$$.fragment, 1), R(e, r.parentNode, r))
						: (e = null);
				} else o && e.$set(i);
			},
			i(t) {
		...
		o && (e = new o(n())),
		{
			...
			p(t, s) {
				...
				if (o !== (o = t[0][2])) {
					...
					o
						? ((e = new o(n())), b(e.$$.fragment), k(e.$$.fragment, 1), R(e, r.parentNode, r))
						: (e = null);
				} else o && e.$set(i);
			},
			i(t) {
	...
	return {
		...
		p(t, r) {
			t[0][2]
				? s
					? (s.p(t, r), 1 & r && k(s, 1))
					: ((s = N(t)), s.c(), k(s, 1), s.m(e.parentNode, e))
				: s &&
				  (U(),
				  q(s, 1, 1, () => {
						s = null;
...
function W(t) {
	...
	return {
		...
		p(t, s) {
			t[5] ? (r ? r.p(t, s) : ((r = K(t)), r.c(), r.m(e, null))) : r && (r.d(1), (r = null));
		},
		d(t) {
			t && f(e), r && r.d();
		}
...
function z(t) {
	...
	return {
		...
		m(t, o) {
			e && R(e, t, o), m(t, r, o), l && l.m(t, o), m(t, s, o), (a = !0);
		},
		p(t, [a]) {
			const c = 2 & a ? L(o, [S(t[1] || {})]) : {};
			if ((525 & a && (c.$$scope = { dirty: a, ctx: t }), n !== (n = t[0][0]))) {
				...
				n
					? ((e = new n(i(t))), b(e.$$.fragment), k(e.$$.fragment, 1), R(e, r.parentNode, r))
					: (e = null);
			} else n && e.$set(c);
			t[4]
				? l
...
const J = {},
	X = function (t, e) {
		...
		if (void 0 === G) {
			...
			G = t && t.supports && t.supports('modulepreload') ? 'modulepreload' : 'preload';
		}
		return Promise.all(
			e.map((t) => {
				if (t in J) return;
	...
	F = [
		() =>
			X(() => import('./pages/__layout.svelte-8bbad35c.js'), [
		...
		() =>
			X(() => import('./error.svelte-48509c4a.js'), [
				'/_app/error.svelte-48509c4a.js',
				'/_app/chunks/vendor-c12218c7.js'
			]),
		() =>
			X(() => import('./pages/index.svelte-88faaaab.js'), [
				'/_app/pages/index.svelte-88faaaab.js',
				'/_app/assets/pages/index.svelte-8196204d.css',
				'/_app/chunks/vendor-c12218c7.js'
			]),
		() =>
			X(() => import('./pages/scuola/a__layout.svelte-f061684e.js'), [
		...
		() =>
			X(() => import('./pages/scuola/Italiano.svelte-10a865a7.js'), [
		...
		() =>
			X(() => import('./pages/scuola/Storia/La-visione-dell-uomo-nel-positivo.md-577ad5f9.js'), [
		...
		() =>
			X(() => import('./pages/scuola/Storia/Prima-guerra-mondiale.md-5b7fb307.js'), [
		...
		() =>
			X(() => import('./pages/scuola/Storia/Il-Novecento.svelte-83cc9d8c.js'), [
		...
		() =>
			X(() => import('./pages/scuola/Storia.svelte-9999c523.js'), [
		...
		() =>
			X(() => import('./pages/scuola.svelte-664fe7f2.js'), [
				'/_app/pages/scuola.svelte-664fe7f2.js',
				'/_app/assets/pages/scuola.svelte-cb810066.css',
				'/_app/chunks/vendor-c12218c7.js',
		...
		() =>
			X(() => import('./pages/About.svelte-84410af4.js'), [
	...
	H = [
		[/^\/$/, [F[0], F[2]], [F[1]]],
		[/^\/scuola\/a__layout\/?$/, [F[0], F[3]], [F[1]]],
		[/^\/scuola\/Italiano\/?$/, [F[0], F[4]], [F[1]]],
		[/^\/scuola\/Storia\/La-visione-dell-uomo-nel-positivo\/?$/, [F[0], F[5]], [F[1]]],
		[/^\/scuola\/Storia\/Prima-guerra-mondiale\/?$/, [F[0], F[6]], [F[1]]],
		[/^\/scuola\/Storia\/Il-Novecento\/?$/, [F[0], F[7]], [F[1]]],
		[/^\/scuola\/Storia\/?$/, [F[0], F[8]], [F[1]]],
		[/^\/scuola\/?$/, [F[0], F[9]], [F[1]]],
		[/^\/About\/?$/, [F[0], F[10]], [F[1]]]
	],
	Q = [F[0](), F[1]()];
		...
		(this.renderer = t),
			...
			addEventListener('scroll', () => {
				clearTimeout(s),
					(s = setTimeout(() => {
						const t =
							((s = i({}, history.state || {})), (a = { 'sveltekit:scroll': Z() }), e(s, r(a)));
						var s, a;
		...
		addEventListener('touchstart', a),
			...
			addEventListener('click', (t) => {
				...
				history.pushState({}, '', n.href),
					this._navigate(n, i ? Z() : null, [], n.hash),
					t.preventDefault();
			}),
	...
	async _navigate(t, e, r, s) {
		...
		if ('/' !== a.path) {
			...
			((t && 'never' === this.trailing_slash) ||
				(!t && 'always' === this.trailing_slash && !a.path.split('/').pop().includes('.'))) &&
				((a.path = t ? a.path.slice(0, -1) : a.path + '/'),
				history.replaceState({}, '', `${a.path}${location.search}`));
		}
...
class at {
	constructor({ Root: t, fallback: e, target: r, session: s, host: a }) {
		(this.Root = t),
			...
			(this.stores = { page: rt({}), navigating: D(null), session: D(s) }),
			(this.$session = null),
			(this.root = null);
		let o = !1;
