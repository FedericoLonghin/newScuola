...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-a8028453.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-a8028453.js", "/./_app/chunks/vendor-db0bfca2.js"]
    },
    fetched: void 0,
    floc: false,
  ...
  return `<header class="${"svelte-1vytpj"}"><div class="${"corner svelte-1vytpj"}"></div>
	...
	<nav class="${"svelte-1vytpj"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-1vytpj"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-1vytpj"}"></path></svg>
		<ul class="${"svelte-1vytpj"}"><li class="${["svelte-1vytpj", $page.path === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-1vytpj"}">Home</a></li>
			<li class="${["svelte-1vytpj", $page.path === "/scuola" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/scuola"}" class="${"svelte-1vytpj"}">Scuola</a></li>
...
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<link rel="${"manifest"}" href="${"/manifest.webmanifest"}" data-svelte="svelte-4n33qg"><meta name="${"description"}" content="${"questo \xE8 il nuovo sitoTest di Federico Longhin"}" data-svelte="svelte-4n33qg"><meta name="${"apple-mobile-web-app-capable"}" content="${"yes"}" data-svelte="svelte-4n33qg"><link rel="${"apple-touch-icon"}" href="${"/pencil-512x512.png"}" data-svelte="svelte-4n33qg"><meta name="${"msapplication-TileColor"}" content="${"#00aba9"}" data-svelte="svelte-4n33qg"><meta name="${"theme-color"}" content="${"#ffffff"}" data-svelte="svelte-4n33qg">`, ""}
...
var css$2 = {
  code: "section.svelte-t0swjm.svelte-t0swjm{display:flex;flex-direction:column;justify-content:center;align-items:center;flex:1}.inline.svelte-t0swjm.svelte-t0swjm{text-align:left;display:flex}.inline.svelte-t0swjm>div.svelte-t0swjm{margin-block-start:0.83em;margin-block-end:0.83em}#title-box.svelte-t0swjm.svelte-t0swjm{font-size:2rem !important}.indice-elem.svelte-t0swjm.svelte-t0swjm{width:100%;text-align:left}.hidden.svelte-t0swjm.svelte-t0swjm{visibility:hidden}.indice-elem-data.svelte-t0swjm.svelte-t0swjm{opacity:0.6;text-align:right;margin-left:auto}",
  map: `{"version":3,"file":"Storia.svelte","sources":["Storia.svelte"],"sourcesContent":["<script context=\\"module\\" lang=\\"ts\\">import { page } from '$app/stores';\\nexport const prerender = true;\\nvar sectionName = 'Storia';\\nvar pageName = 'Maino';\\n</script>\\n\\n<svelte:head>\\n\\t<title>{pageName}</title>\\n</svelte:head>\\n\\n<div id=\\"title-box\\" class=\\"inline\\">\\n\\t<div>\\n\\t\\t<a href=\\"/Scuola/{sectionName}\\">{sectionName}</a>\\n\\t</div>\\n\\t\\t<div style=\\"margin-left:10px\\"class:hidden={pageName === 'Main'}>/{pageName}</div>\\n\\t\\n</div>\\n\\n<section>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - Il novecento</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\">\\n\\t\\t\\t\\t- Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, ex!/a>\\n\\t\\t\\t</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La prima guerra mondiale</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La divina commedia di alessandro manzoni</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - Il novecento</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\">\\n\\t\\t\\t\\t- Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, ex!/a>\\n\\t\\t\\t</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La prima guerra mondiale</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La divina commedia di alessandro manzoni</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - Il novecento</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\">\\n\\t\\t\\t\\t- Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, ex!/a>\\n\\t\\t\\t</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La prima guerra mondiale</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La divina commedia di alessandro manzoni</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - Il novecento</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\">\\n\\t\\t\\t\\t- Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, ex!/a>\\n\\t\\t\\t</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La prima guerra mondiale</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La divina commedia di alessandro manzoni</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - Il novecento</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\">\\n\\t\\t\\t\\t- Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, ex!/a>\\n\\t\\t\\t</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La prima guerra mondiale</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La divina commedia di alessandro manzoni</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - Il novecento</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\">\\n\\t\\t\\t\\t- Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, ex!/a>\\n\\t\\t\\t</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La prima guerra mondiale</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La divina commedia di alessandro manzoni</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - Il novecento</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\">\\n\\t\\t\\t\\t- Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, ex!/a>\\n\\t\\t\\t</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La prima guerra mondiale</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La divina commedia di alessandro manzoni</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - Il novecento</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\">\\n\\t\\t\\t\\t- Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, ex!/a>\\n\\t\\t\\t</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La prima guerra mondiale</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n\\t<div class=\\"indice-elem inline\\">\\n\\t\\t<div>\\n\\t\\t\\t<a href=\\"/Scuola/Storia/Il-Novecento\\"> - La divina commedia di alessandro manzoni</a>\\n\\t\\t</div>\\n\\t\\t<div style=\\"width: auto;\\" />\\n\\t\\t<div class=\\"indice-elem-data\\">03/11/2021</div>\\n\\t</div>\\n</section>\\n\\n<style>\\n\\tsection {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tjustify-content: center;\\n\\t\\talign-items: center;\\n\\t\\tflex: 1;\\n\\t}\\n\\n\\th1 {\\n\\t\\twidth: 100%;\\n\\t}\\n\\n\\t.inline {\\n\\t\\ttext-align: left;\\n\\t\\tdisplay: flex;\\n\\t}\\n\\t.inline > div {\\n\\t\\tmargin-block-start: 0.83em;\\n\\t\\tmargin-block-end: 0.83em;\\n\\t}\\n\\t#title-box {\\n\\t\\tfont-size: 2rem !important;\\n\\t}\\n\\t.indice-elem {\\n\\t\\twidth: 100%;\\n\\t\\ttext-align: left;\\n\\t}\\n\\t.hidden {\\n\\t\\tvisibility: hidden;\\n\\t}\\n\\t.indice-elem-data {\\n\\t\\topacity: 0.6;\\n\\t\\ttext-align: right;\\n\\t\\tmargin-left: auto;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA+PC,OAAO,4BAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,IAAI,CAAE,CAAC,AACR,CAAC,AAMD,OAAO,4BAAC,CAAC,AACR,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,IAAI,AACd,CAAC,AACD,qBAAO,CAAG,GAAG,cAAC,CAAC,AACd,kBAAkB,CAAE,MAAM,CAC1B,gBAAgB,CAAE,MAAM,AACzB,CAAC,AACD,UAAU,4BAAC,CAAC,AACX,SAAS,CAAE,IAAI,CAAC,UAAU,AAC3B,CAAC,AACD,YAAY,4BAAC,CAAC,AACb,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,AACjB,CAAC,AACD,OAAO,4BAAC,CAAC,AACR,UAAU,CAAE,MAAM,AACnB,CAAC,AACD,iBAAiB,4BAAC,CAAC,AAClB,OAAO,CAAE,GAAG,CACZ,UAAU,CAAE,KAAK,CACjB,WAAW,CAAE,IAAI,AAClB,CAAC"}`
};
...
<div id="${"title-box"}" class="${"inline svelte-t0swjm"}"><div class="${"svelte-t0swjm"}"><a href="${"/Scuola/" + escape2(sectionName)}">${escape2(sectionName)}</a></div>
		<div style="${"margin-left:10px"}" class="${["svelte-t0swjm", ""].join(" ").trim()}">/${escape2(pageName)}</div></div>

<section class="${"svelte-t0swjm"}"><div class="${"indice-elem inline svelte-t0swjm"}"><div class="${"svelte-t0swjm"}"><a href="${"/Scuola/Storia/Il-Novecento"}">- Il novecento</a></div>
		<div style="${"width: auto;"}" class="${"svelte-t0swjm"}"></div>
		<div class="${"indice-elem-data svelte-t0swjm"}">03/11/2021</div></div>
	<div class="${"indice-elem inline svelte-t0swjm"}"><div class="${"svelte-t0swjm"}"><a href="${"/Scuola/Storia/Il-Novecento"}">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, ex!/a&gt;
			</a></div>
		<div style="${"width: auto;"}" class="${"svelte-t0swjm"}"></div>
		<div class="${"indice-elem-data svelte-t0swjm"}">03/11/2021</div></div>
	<div class="${"indice-elem inline svelte-t0swjm"}"><div class="${"svelte-t0swjm"}"><a href="${"/Scuola/Storia/Il-Novecento"}">- La prima guerra mondiale</a></div>
		<div style="${"width: auto;"}" class="${"svelte-t0swjm"}"></div>
		<div class="${"indice-elem-data svelte-t0swjm"}">03/11/2021</div></div>
	<div class="${"indice-elem inline svelte-t0swjm"}"><div class="${"svelte-t0swjm"}"><a href="${"/Scuola/Storia/Il-Novecento"}">- La divina commedia di alessandro manzoni</a></div>
		<div style="${"width: auto;"}" class="${"svelte-t0swjm"}"></div>
		<div class="${"indice-elem-data svelte-t0swjm"}">03/11/2021</div></div>	<div class="${"indice-elem inline svelte-t0swjm"}"><div class="${"svelte-t0swjm"}"><a href="${"/Scuola/Storia/Il-Novecento"}">- Il novecento</a></div>
		<div style="${"width: auto;"}" class="${"svelte-t0swjm"}"></div>
		<div class="${"indice-elem-data svelte-t0swjm"}">03/11/2021</div></div>
	<div class="${"indice-elem inline svelte-t0swjm"}"><div class="${"svelte-t0swjm"}"><a href="${"/Scuola/Storia/Il-Novecento"}">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, ex!/a&gt;
			</a></div>
...
<div class="${"content svelte-18hzus"}"><h1>Benvenuto nella sezione scuola</h1>

	<p>Qui troverai tutti gli appunti divisi per materie etc...</p>

	<p>Materie:</p>

	<p class="${"link-holder svelte-18hzus"}"><a sveltekit:prefetch href="${"/Scuola/Italiano"}">- Italiano</a>
		<br>
