...
var ReloadPrompt = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  toast = needRefresh;
  return `${toast ? `<div class="${"pwa-toast svelte-1sc0yvd"}" role="${"alert"}"><div class="${"message svelte-1sc0yvd"}">${`<span>New content available, click on reload button to update. </span>`}</div>
		${``}
...
<div class="${"content svelte-cf77e8"}"><h1>Benvenuto</h1>
	...
	<p>Teoricamente qua dovrei fare una bella sezione per la scuola... chiss\xE0 se funzioner\xE0 realmente
	</p>
</div>`;
});
