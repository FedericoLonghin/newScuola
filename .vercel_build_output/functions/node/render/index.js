...
var require_snarkdown = __commonJS({
	'node_modules/snarkdown/dist/snarkdown.js'(exports, module2) {
		...
		module2.exports = function t(a, o) {
			...
			function f() {
				for (var e2 = ''; m.length; ) e2 += $(m[m.length - 1]);
				return e2;
			}
			for (
				a = a
					.replace(/^\[(.+?)\]:\s*(.+)$/gm, function (e2, n2, r2) {
				...
				(l = a.substring(d, s2.index)),
					...
					l.match(/[^\\](\\\\)*\\$/) ||
						((p = s2[3] || s2[4])
							? (c =
									'<pre class="code ' +
									(s2[4] ? 'poetry' : s2[2].toLowerCase()) +
									'"><code' +
									(s2[2] ? ' class="language-' + s2[2].toLowerCase() + '"' : '') +
									'>' +
									n(r(p).replace(/^\n+|\n+$/g, '')) +
									'</code></pre>')
							: (p = s2[6])
							? (p.match(/\./) && (s2[5] = s2[5].replace(/^\d+/gm, '')),
							  (g = t(n(s2[5].replace(/^\s*[>*+.-]/gm, '')))),
							  p == '>'
									? (p = 'blockquote')
									: ((p = p.match(/\./) ? 'ol' : 'ul'),
									  (g = g.replace(/^(.*)(\n|$)/gm, '<li>$1</li>'))),
							  (c = '<' + p + '>' + g + '</' + p + '>'))
							: s2[8]
							? (c = '<img src="' + r(s2[8]) + '" alt="' + r(s2[7]) + '">')
							: s2[10]
							? ((h = h.replace('<a>', '<a href="' + r(s2[11] || i[l.toLowerCase()]) + '">')),
							  (c = f() + '</a>'))
							: s2[9]
							? (c = '<a>')
							: s2[12] || s2[14]
							? (c =
									'<' +
									(p = 'h' + (s2[14] ? s2[14].length : s2[13] > '=' ? 1 : 2)) +
									'>' +
									t(s2[12] || s2[15], i) +
									'</' +
									p +
...
var module_lookup = {
	...
	'src/routes/scuola/a__layout.svelte': () =>
		Promise.resolve().then(function () {
			return a__layout;
		}),
	...
	'src/routes/scuola/Storia/Prima-guerra-mondiale.md': () =>
		Promise.resolve().then(function () {
...
var metadata_lookup = {
	'src/routes/__layout.svelte': {
		entry: '/./_app/pages/__layout.svelte-8bbad35c.js',
		css: [
			'/./_app/assets/pages/__layout.svelte-75c30209.css',
			'/./_app/assets/index.svelte_svelte&type=style&lang-87aef973.css'
		],
		js: [
			'/./_app/pages/__layout.svelte-8bbad35c.js',
			'/./_app/chunks/vendor-c12218c7.js',
			'/./_app/chunks/stores-52090410.js'
		],
		styles: null
	},
	'.svelte-kit/build/components/error.svelte': {
		entry: '/./_app/error.svelte-48509c4a.js',
		css: [],
		js: ['/./_app/error.svelte-48509c4a.js', '/./_app/chunks/vendor-c12218c7.js'],
		styles: null
	},
	'src/routes/index.svelte': {
		entry: '/./_app/pages/index.svelte-88faaaab.js',
		css: ['/./_app/assets/pages/index.svelte-8196204d.css'],
		js: ['/./_app/pages/index.svelte-88faaaab.js', '/./_app/chunks/vendor-c12218c7.js'],
		styles: null
	},
	'src/routes/scuola/a__layout.svelte': {
		entry: '/./_app/pages/scuola/a__layout.svelte-f061684e.js',
		css: ['/./_app/assets/index.svelte_svelte&type=style&lang-87aef973.css'],
		js: [
			'/./_app/pages/scuola/a__layout.svelte-f061684e.js',
			'/./_app/chunks/vendor-c12218c7.js',
			'/./_app/chunks/index-94375af2.js',
			'/./_app/chunks/stores-52090410.js'
		],
		styles: null
	},
	'src/routes/scuola/Italiano.svelte': {
		entry: '/./_app/pages/scuola/Italiano.svelte-10a865a7.js',
		css: [
			'/./_app/assets/pages/scuola/Italiano.svelte-bcdbeabc.css',
			'/./_app/assets/index.svelte_svelte&type=style&lang-87aef973.css'
		],
		js: [
			'/./_app/pages/scuola/Italiano.svelte-10a865a7.js',
			'/./_app/chunks/vendor-c12218c7.js',
			'/./_app/chunks/index-94375af2.js',
			'/./_app/chunks/stores-52090410.js'
		],
	...
	'src/routes/scuola/Storia/La-visione-dell-uomo-nel-positivo.md': {
		entry: '/./_app/pages/scuola/Storia/La-visione-dell-uomo-nel-positivo.md-577ad5f9.js',
		css: ['/./_app/assets/index.svelte_svelte&type=style&lang-87aef973.css'],
		js: [
			'/./_app/pages/scuola/Storia/La-visione-dell-uomo-nel-positivo.md-577ad5f9.js',
			'/./_app/chunks/vendor-c12218c7.js',
			'/./_app/chunks/index-94375af2.js',
			'/./_app/chunks/stores-52090410.js'
		],
	...
	'src/routes/scuola/Storia/Prima-guerra-mondiale.md': {
		entry: '/./_app/pages/scuola/Storia/Prima-guerra-mondiale.md-5b7fb307.js',
		css: ['/./_app/assets/index.svelte_svelte&type=style&lang-87aef973.css'],
		js: [
			'/./_app/pages/scuola/Storia/Prima-guerra-mondiale.md-5b7fb307.js',
			'/./_app/chunks/vendor-c12218c7.js',
			'/./_app/chunks/index-94375af2.js',
			'/./_app/chunks/stores-52090410.js'
		],
	...
	'src/routes/scuola/Storia/Il-Novecento.svelte': {
		entry: '/./_app/pages/scuola/Storia/Il-Novecento.svelte-83cc9d8c.js',
		css: [
			'/./_app/assets/pages/scuola/Storia/Il-Novecento.svelte-a7d5c656.css',
			'/./_app/assets/index.svelte_svelte&type=style&lang-87aef973.css'
		],
		js: [
			'/./_app/pages/scuola/Storia/Il-Novecento.svelte-83cc9d8c.js',
			'/./_app/chunks/vendor-c12218c7.js',
			'/./_app/chunks/index-94375af2.js',
			'/./_app/chunks/stores-52090410.js'
		],
	...
	'src/routes/scuola/Storia.svelte': {
		entry: '/./_app/pages/scuola/Storia.svelte-9999c523.js',
		css: [
			'/./_app/assets/pages/scuola/Italiano.svelte-bcdbeabc.css',
			'/./_app/assets/index.svelte_svelte&type=style&lang-87aef973.css'
		],
		js: [
			'/./_app/pages/scuola/Storia.svelte-9999c523.js',
			'/./_app/chunks/vendor-c12218c7.js',
			'/./_app/chunks/stores-52090410.js',
			'/./_app/chunks/index-4cc4db53.js',
			'/./_app/chunks/index-94375af2.js'
		],
		styles: null
	},
	'src/routes/scuola.svelte': {
		entry: '/./_app/pages/scuola.svelte-664fe7f2.js',
		css: ['/./_app/assets/pages/scuola.svelte-cb810066.css'],
		js: [
			'/./_app/pages/scuola.svelte-664fe7f2.js',
			'/./_app/chunks/vendor-c12218c7.js',
	...
	'src/routes/About.svelte': {
		entry: '/./_app/pages/About.svelte-84410af4.js',
		css: ['/./_app/assets/pages/scuola.svelte-cb810066.css'],
		js: [
			'/./_app/pages/About.svelte-84410af4.js',
			'/./_app/chunks/vendor-c12218c7.js',
			'/./_app/chunks/env-a13806e5.js'
		],
		styles: null
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	<nav class="${'svelte-1vytpj'}"><svg viewBox="${'0 0 2 3'}" aria-hidden="${'true'}" class="${'svelte-1vytpj'}"><path d="${'M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z'}" class="${'svelte-1vytpj'}"></path></svg>
		<ul class="${'svelte-1vytpj'}"><li class="${['svelte-1vytpj', $page.path === '/' ? 'active' : '']
		.join(' ')
		.trim()}"><a sveltekit:prefetch href="${'/'}" class="${'svelte-1vytpj'}">Home</a></li>
			<li class="${['svelte-1vytpj', $page.path.split('/')[1] === 'scuola' ? 'active' : '']
				.join(' ')
				.trim()}"><a sveltekit:prefetch href="${'/scuola'}" class="${'svelte-1vytpj'}">Scuola</a></li>
			<li class="${['svelte-1vytpj', $page.path === '/About' ? 'active' : '']
				.join(' ')
				.trim()}"><a sveltekit:prefetch href="${'/About'}" class="${'svelte-1vytpj'}">About</a></li></ul>
...
var css$7 = {
	code:
		'.inline.svelte-2oaaq3.svelte-2oaaq3{text-align:left;display:flex}.inline.svelte-2oaaq3>div.svelte-2oaaq3{margin-block-start:0.83em;margin-block-end:0.83em}#title-box.svelte-2oaaq3.svelte-2oaaq3{font-size:1.6rem !important}',
...
var IndicePath = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	$$unsubscribe_page();
	return `<div id="${'title-box'}" class="${'inline svelte-2oaaq3'}"><div class="${'svelte-2oaaq3'}"><a href="${
		'/scuola/' + escape2(sectionName)
	}">${escape2(sectionName)}</a></div>
	<div style="${'margin-left:10px; color: var(--heading-color); '}" class="${[
		'svelte-2oaaq3',
		typeof pageName2 === 'undefined' ? 'hidden' : ''
	]
		.join(' ')
		.trim()}">/${escape2(pageName2)}</div>
</div>`;
});
var css$6 = {
	code:
...
var css$5 = {
	code:
		'.content.svelte-13qm1wo{width:100%;max-width:var(--column-width);margin:var(--column-margin-top) auto 0 auto}h1.svelte-13qm1wo{width:100%}',
	map:
...
var css$4 = {
	code:
		'section.svelte-1jlhe5t{display:flex;flex-direction:column;justify-content:center;align-items:center;flex:1}',
	map:
		'{"version":3,"file":"Italiano.svelte","sources":["Italiano.svelte"],"sourcesContent":["<script context=\\"module\\" lang=\\"ts\\">import snarkdown from \'snarkdown\';\\nconst source = `\\n\\t# This is a header`;\\nlet md = \'_this_ is very very is **easy** to ``use``.\';\\nlet html = snarkdown(md);\\nconsole.log(html);\\nexport const prerender = true;\\n</script>\\n\\n<script>\\n\\timport IndicePath from \'$lib/IndicePath/index.svelte\';\\n</script>\\n\\n<IndicePath />\\n\\n<svelte:head>\\n\\t<title>Home</title>\\n</svelte:head>\\n\\n<section>\\n\\t{@html snarkdown(md)}\\n</section>\\n\\n<style>\\n\\tsection {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tjustify-content: center;\\n\\t\\talign-items: center;\\n\\t\\tflex: 1;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAwBC,OAAO,eAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,IAAI,CAAE,CAAC,AACR,CAAC"}'
};
...
<section class="${'svelte-1jlhe5t'}"><!-- HTML_TAG_START -->${(0, import_snarkdown.default)(
		md
	)}<!-- HTML_TAG_END -->
</section>`;
});
...
<section class="${'svelte-1jlhe5t'}">${validate_component(IndiceElement, 'IndiceElement').$$render(
		$$result,
		{
			pageURL: $page.path,
	...
	${validate_component(IndiceElement, 'IndiceElement').$$render(
		$$result,
		{
			pageURL: $page.path,
